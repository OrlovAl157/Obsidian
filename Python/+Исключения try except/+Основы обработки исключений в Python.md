...
### Пример 3: Работа с файлами (классический способ)
...
### Пример 4: Работа с файлами (with — рекомендуется)
...
print(get_element(numbers, 'a'))  # None
```
