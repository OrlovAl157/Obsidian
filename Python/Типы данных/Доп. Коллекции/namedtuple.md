...
Все примеры в таблице ниже основаны на этом коде ⬇
...
- [Исходный код namedtuple](https://github.com/python/cpython/blob/main/Lib/collections/_init_.py)