...
# Сохранение разделителей (через группы захвата)
re.split(r'([,;:])', text)
# ['apple', ',', 'banana', ';', 'orange', ':', 'grape']
...
# Разделение по словам (сохранение разделителей)
text3 = "Price: $100, Discount: 20%"
re.split(r'(\$\d+|%)', text3)
# ['Price: ', '$100', ', Discount: 20', '%', '']
```

**Отличие от `str.split()`:**

- `str.split()` — только один разделитель
- `re.split()` — regex паттерн, несколько разделителей, сохранение разделителей​​​​​​​​​​​​​​​​
---
