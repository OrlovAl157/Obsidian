# Регулярные выражения Python (re) — Полная памятка
...
|---|---|---|---|
|**Жадный**|`*`, `+`, `?`, `{n,m}`|Максимальное совпадение|✅ Да|
|**Ленивый**|`*?`, `+?`, `??`, `{n,m}?`|Минимальное совпадение|✅ Да|
|**Ревнивый**|`*+`, `++`, `?+`, `{n,m}+`|Максимальное, без отката|❌ Нет|
