...
numbers = [1, 2, 3, 4]
numbers = numbers.append(5)  # ⚠️ ОШИБКА! (append возвращает None)
print(numbers)  # None
...
# Пример 9: Очистка списка через срез
letters = ['a', 'b', 'c']
letters[:] = []
print(letters)  # []
...
Вся информация по спискам сохранена. Что добавим следующим в нашу базу? Можем переходить к **Словарям (dict)** или **Строкам (str)**.